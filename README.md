...
- [Lunch Money JS/TS Tools](#lunch-money-jsts-tools)
  - [Contents](#contents)
  - [✨ Features](#-features)
  ...
  - [CLI Usage](#cli-usage)
    ...
    - [Transactions](#transactions)
      - [Get single transaction by ID:](#get-single-transaction-by-id)
      - [Update Transaction](#update-transaction)
    - [Accounts](#accounts)
    - [Categories / Tags](#categories--tags)
    - [Splitwise Integration](#splitwise-integration)
      - [List Splitwise Expenses](#list-splitwise-expenses)
      - [Import Splitwise Expenses to Lunch Money](#import-splitwise-expenses-to-lunch-money)
      - [Import Lunch Money Transactions to Splitwise](#import-lunch-money-transactions-to-splitwise)
  - [API Reference](#api-reference)
    - [`LunchMoneyApi`](#lunchmoneyapi)
    - [Type Definitions](#type-definitions)
    - [API Examples](#api-examples)
      - [Transaction Management](#transaction-management)
      - [Splitwise Integration](#splitwise-integration-1)
  - [License](#license)
