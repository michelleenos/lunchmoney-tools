...
export interface LMTransaction {
    ...
    recurring_cadence?: 'once a week' | 'every 2 weeks' | 'twice a month' | 'monthly' | 'every 2 months' | 'every 3 months' | 'every 4 months' | 'twice a year' | 'yearly' | null;
     ...
     */
    group_id?: number;
    children?: Pick<LMTransaction, 'id' | 'date' | 'amount' | 'payee' | 'notes' | 'asset_id' | 'plaid_account_id'>[];
}
